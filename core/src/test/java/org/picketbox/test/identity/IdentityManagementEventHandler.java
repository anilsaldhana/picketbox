...
public class IdentityManagementEventHandler {
    ...
    public void onCreatedUser(UserCreatedEvent event) {
        this.createdUser = event.getUser();
    }

    @EventObserver
    public void onUpdatedUser(UserCreatedEvent event) {
        this.updatedUser = event.getUser();
    }

    @EventObserver
    public void onRemovedUser(UserCreatedEvent event) {
        this.removedUser = event.getUser();
    }
